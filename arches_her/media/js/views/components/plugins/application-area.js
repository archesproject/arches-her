...
import ApplicationAreaTemplate from "templates/views/components/plugins/application-area.htm";
import "views/components/workflows/new-tile-step";
import "views/components/workflows/application-area/app-area-final-step";
import { generateArchesURL } from "@/arches/utils/generate-arches-url.ts";

export default ko.components.register("application-area", {
    viewModel: function (params) {
        ...
        this.stepConfig = [
                        ...
                        componentConfigs: [
                            {
                                ...
                                uniqueInstanceName:
                                    "app-area-name" /* unique to step */,
                                tilesManaged: "one",
                                parameters: {
                                    graphid:
                                        "42ce82f6-83bf-11ea-b1e8-f875a44e0e11",
                                    nodegroupid:
                                        "9c9f9dbb-83bf-11ea-bca7-f875a44e0e11",
                        ...
                        componentConfigs: [
                            {
                                ...
                                parameters: {
                                    graphid:
                                        "42ce82f6-83bf-11ea-b1e8-f875a44e0e11",
                                    nodegroupid:
                                        "faa0a425-94ff-11ea-8dea-f875a44e0e11",
                                    resourceid:
            ...
            },
            {
                ...
                name: "area-map",
                description:
                    "Draw (or select from the Development Area Overlay) the extent of...",
                required: true,
                        ...
                        componentConfigs: [
                            {
                                ...
                                uniqueInstanceName:
                                    "area-map" /* unique to step */,
                                tilesManaged: "one",
                                parameters: {
                                    graphid:
                                        "42ce82f6-83bf-11ea-b1e8-f875a44e0e11",
                                    nodegroupid:
                                        "19096dc5-3a3b-11eb-b4cf-f875a44e0e11",
                                    resourceid:
                                        "['assign-name']['app-area-name'][0]['resourceid']['resourceInstanceId']",
                                },
                            },
                        ...
                        componentConfigs: [
                            {
                                componentName: "default-card",
                                uniqueInstanceName:
                                    "related-heritage-resource" /* unique to step */,
                                tilesManaged: "one",
                                parameters: {
                                    graphid:
                                        "42ce82f6-83bf-11ea-b1e8-f875a44e0e11",
                                    nodegroupid:
                                        "a93c73b4-83d4-11ea-80e6-f875a44e0e11",
                                    resourceid:
                                        "['assign-name']['app-area-name'][0]['resourceid']['resourceInstanceId']",
                                },
                            },
                        ...
                        componentConfigs: [
                            {
                                ...
                                parameters: {
                                    graphid:
                                        "42ce82f6-83bf-11ea-b1e8-f875a44e0e11",
                                    nodegroupid:
                                        "7a76715d-94fd-11ea-8481-f875a44e0e11",
                                    resourceid:
                                        "['assign-name']['app-area-name'][0]['resourceid']['resourceInstanceId']",
                                },
                            },
                        ...
                        componentConfigs: [
                            {
                                ...
                                parameters: {
                                    graphid:
                                        "42ce82f6-83bf-11ea-b1e8-f875a44e0e11",
                                    nodegroupid:
                                        "48f51523-efde-11eb-8285-a87eeabdefba",
                                    resourceid:
                                        "['assign-name']['app-area-name'][0]['resourceid']['resourceInstanceId']",
                                },
                            },
