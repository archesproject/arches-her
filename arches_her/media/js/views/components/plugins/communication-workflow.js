...
import CommunicationWorkflowTemplate from "templates/views/components/plugins/communication-workflow.htm";
import "views/components/workflows/communication-workflow/communication-select-resource";
import "views/components/workflows/communication-workflow/upload-document-step";
import "views/components/workflows/communication-workflow/communication-final-step";
import { generateArchesURL } from "@/arches/utils/generate-arches-url.ts";

export default ko.components.register("communication-workflow", {
                        ...
                        componentConfigs: [
                            {
                                ...
                                uniqueInstanceName:
                                    "communication-select-resource" /* unique to step */,
                                tilesManaged: "one",
                                parameters: {
                                    graphid:
                                        "8d41e49e-a250-11e9-9eab-00224800b26d",
                                    nodegroupid:
                                        "caf5bff1-a3d7-11e9-aa28-00224800b26d",
                                },
                            },
                        ],
                    },
                        ...
                        componentConfigs: [
                            {
                                ...
                                uniqueInstanceName:
                                    "communication-notes-step" /* unique to step */,
                                tilesManaged: "one",
                                parameters: {
                                    graphid:
                                        "8d41e49e-a250-11e9-9eab-00224800b26d",
                                    nodegroupid:
                                        "caf5bff1-a3d7-11e9-aa28-00224800b26d",
                                    resourceid:
                                        "['related-consultation']['communication-select-resource']['resourceInstanceId']",
                        ...
                        componentConfigs: [
                            {
                                componentName: "default-card",
                                uniqueInstanceName:
                                    "communication-follow-on-actions-step" /* unique to step */,
                                tilesManaged: "one",
                                parameters: {
                                    graphid:
                                        "8d41e49e-a250-11e9-9eab-00224800b26d",
                        ...
                        componentConfigs: [
                            {
                                ...
                                uniqueInstanceName:
                                    "upload-documents-step" /* unique to step */,
                                tilesManaged: "one",
                                parameters: {
                                    graphid:
                                        "a535a235-8481-11ea-a6b9-f875a44e0e11",
                                    nodegroupid:
                                        "7db68c6c-8490-11ea-a543-f875a44e0e11",
                        ...
                        componentConfigs: [
                            {
                                ...
                                parameters: {
                                    digitalObject:
                                        "['upload-documents']['upload-documents-step']",
                                    consultationResourceid:
                                        "['related-consultation']['communication-select-resource']['resourceInstanceId']",
                                    consultationTileid:
                                        "['related-consultation']['communication-select-resource']['tileId']",
