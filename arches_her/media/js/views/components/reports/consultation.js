...
export default ko.components.register("consultation-report", {
    viewModel: function (params) {
            ...
            self.references(
                referencesNode.map((node) => {
                    ...
                    if (urlNodeValue) {
                        ...
                        urlLabel = urlNodeValue.url_label
                            ? urlNodeValue.url_label
                            : urlNodeValue.url;
                    }
        ...
        if (outcomesNode) {
            const planningOutcome = self.getNodeValue(
                outcomesNode,
                "planning outcome"
            );
        ...
        if (contactNode) {
            ...
            const planningOfficerLink = self.getNodeValue(
                contactNode,
                "planning officers",
                "planning officer",
                "resourceid"
            ...
            const planningBodyLink = self.getNodeValue(
                contactNode,
                "planning officers",
                "planning body",
                "resourceid"
            );
            const caseworkOfficer = self.getNodeValue(
                contactNode,
                "casework officers",
                "casework officer"
            );
            const caseworkOfficerLink = self.getNodeValue(
                contactNode,
                "casework officers",
                "casework officer",
                "resourceid"
            ...
            const applicants = Array.isArray(applicantsNodes)
                ? applicantsNodes.map((applicantsNode) => {
                      ...
                      const applicantLink =
                          self.getResourceLink(applicantsNode);
