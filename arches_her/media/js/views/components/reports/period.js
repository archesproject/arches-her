...
import PeriodTemplate from "templates/views/components/reports/period.htm";
...
export default ko.components.register("period-report", {
    viewModel: function (params) {
        ...
        const alternativeNameNode = self.getRawNodeValue(
            self.resource(),
            "alternative names"
        );
