...
import ApplicationAreaTemplate from "templates/views/components/reports/application-area.htm";
import "views/components/reports/scenes/name";
import "views/components/reports/scenes/referenced-by";
...
export default ko.components.register("application-area-report", {
    viewModel: function (params) {
        ...
        self.resourceinstanceid = ko.observable(
            params.report?.report_json?.resourceinstanceid
        );
        ...
        const associatedApplicationAreas = self.getRawNodeValue(
            self.resource(),
        ...
        if (Array.isArray(associatedApplicationAreas)) {
            ...
            self.applicationAreas(
                associatedApplicationAreas.map((x) => {
