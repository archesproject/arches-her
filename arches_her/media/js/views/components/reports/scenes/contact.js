...
import ContactTemplate from "templates/views/components/reports/scenes/contact.htm";
...
export default ko.components.register(
    "views/components/reports/scenes/contact",
    {
        viewModel: function (params) {
            ...
            const contactNode = self.getRawNodeValue(
                params.data(),
                self.dataConfig.contact
            );

            if (contactNode) {
                self.contact(
                    contactNode.map((node) => {
