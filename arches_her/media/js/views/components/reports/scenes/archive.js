...
import ArchiveTemplate from "templates/views/components/reports/scenes/archive.htm";
    ...
    "views/components/reports/scenes/archive",
    {
        viewModel: function (params) {
            ...
            if (params?.compiled) {
                ...
                const repositoryStorageNode = self.getRawNodeValue(
                    params.data(),
                    self.dataConfig.repositoryStorage
                );
                if (repositoryStorageNode) {
                    const repositoryOwner = self.getNodeValue(
                        repositoryStorageNode,
                        "repository owner"
                    );
                ...
                const sourceCreationNode = self.getRawNodeValue(
                    params.data(),
                    self.dataConfig.sourceCreation
                );
