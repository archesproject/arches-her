...
import CorrespondenceLetterStepTemplate from "templates/views/components/workflows/correspondence-letter-step.htm";
...
function viewModel(params) {
    ...
    this.retrieveFile = function (tile) {
        ...
        var templateId =
            letterTypeTiles[letterTypeTiles.length - 1].data[
                self.letterTypeNodeId
            ]();
        $.ajax({
            type: "POST",
...
export default ko.components.register("correspondence-letter-step", {
    viewModel: viewModel,
