...
import SiteVisitFinalStepTemplate from "templates/views/components/workflows/site-visit/site-visit-final-step.htm";
...
function viewModel(params) {
    ...
    this.resourceData.subscribe(function (val) {
        ...
        try {
            this.reportVals.attendees = currentSiteVisit["Attendees"].map(
                function (attendee) {
                    return {
                        attendee: {
                            name: "Attendee",
                            value: self.getResourceValue(attendee, [
                                "Attendee",
                                "@value",
                            ]),
                        },
        ...
        try {
            this.reportVals.observations = currentSiteVisit["Observations"].map(
                function (obs) {
                    return {
                        observation: {
                            name: "observation",
                            value: self.getResourceValue(obs, [
                                "Observation",
                                "Observation Notes",
                                "@value",
                            ]),
        ...
        try {
            this.reportVals.recommendations = currentSiteVisit[
                "Recommendations"
            ].map(function (rec) {
                return {
                    recommendation: {
        ...
        try {
            this.reportVals.photographs = currentSiteVisit["Photographs"].map(
                function (photograph) {
                    return {
                        photo: {
                            name: "Photo",
