...
import ConsultationConditionsMitigationsTemplate from "templates/views/components/reports/consultations-conditions-mitigations.htm";

export default ko.components.register("consultations-conditions-mitigations", {
    ...
    template: ConsultationConditionsMitigationsTemplate,
});
