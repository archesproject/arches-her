...
import ConsultationsStatusTemplate from "templates/views/components/reports/consultations-status.htm";

export default ko.components.register("consultations-status", {
    viewModel: function (params) {
        ...
        this.references = ko.computed(function () {
            ...
            return tiles.map(function (tile) {
                return {
                    identifier:
                        tile.data["c128bf36-9384-11ea-bfe1-f875a44e0e11"],
                    agency: tile.data["8d41e4dc-a250-11e9-8e44-00224800b26d"],
                };
            });
        });
    },
    template: ConsultationsStatusTemplate,
});
