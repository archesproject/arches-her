...
function($, _, arches, ko, koMapping, FunctionViewModel, chosen) {
    return ko.components.register('views/components/functions/he-primary-descriptors', {
        viewModel: function(params) {
            FunctionViewModel.apply(this, arguments);
            var nodegroups = {};
            this.cards = ko.observableArray();
            this.loading = ko.observable(false);
            this.show_prn = ko.observable(false);
            this.cards.unshift({
                'name': null,
            });
        ...
        template: {
            require: 'text!templates/views/components/functions/he-primary-descriptors.htm'
        }
    });
});
