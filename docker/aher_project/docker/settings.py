"""
Django settings for aher_project project.
"""
...
# COPIED FROM ./arches_her/docker/aher_project/docker/settings.py

APP_NAME = 'aher_project'
...
DATATYPE_LOCATIONS.append('aher_project.datatypes')
FUNCTION_LOCATIONS.append('aher_project.functions')
ETL_MODULE_LOCATIONS.append('aher_project.etl_modules')
SEARCH_COMPONENT_LOCATIONS.append('aher_project.search_components')
...
SECRET_KEY = '8$62)&uj*w(=s^psvrlmg+by3ou8wb16m^cm%e++p)6cfgsyb#'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = 'aher_project.urls'
...
ELASTICSEARCH_PREFIX = 'aher_project'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'aher_project.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    "compressor",
    # "silk",
    # arches_her app added
    "arches_her",
    # project added after arcghes_her app
    "aher_project",
)
...
WSGI_APPLICATION = 'aher_project.wsgi.application'
...
SESSION_COOKIE_NAME = 'aher_project'
