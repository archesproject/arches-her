...
function($, _, BaseFilter, bootstrap, arches, select2, ko, koMapping, viewdata) {
    ...
    return ko.components.register(componentName, {
            ...
            updateResults: function(){
                ...
                if (!!this.searchResults.results){
                    ...
                    this.searchResults.results.hits.hits.forEach(function(result){
                        ...
                        var applicationTypeTile = null, applicationTypeConcept = null;
                        ...
                        var applicationType = (applicationTypeConcept) ? applicationTypeConcept['label'] : null;
                        this.results.push({
        ...
        template: { require: 'text!templates/views/components/search/search-results-consultations.htm' }
    });
});
